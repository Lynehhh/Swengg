        ...
        <section class="signup">
            ...
            <div class="container">
                <div class="signup-content">
                    <form method="POST" action = "processsignup.php" id="signup-form" class="signup-form">
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-1 col-lg-9 offset-lg-0">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        <input type="password" class="form-input" name="confPassword" id="confPassword" placeholder="Confirm Password"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-input" name="address" id="address" placeholder="Street Address"/>
                                    </div>
                                </div>
