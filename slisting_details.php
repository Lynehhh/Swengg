                ...
                <div class="widget">
                    ...
                    <div class="row mb-20">
                            ...
                            <div class="col-md-10 offset-md-1 col-lg-6 offset-lg-0">
                                ...
                                <input type="text" class="form-control" value="<?php echo $_SESSION['price'] ?>" readonly/>
                            </div>
                            <!-- Availability -->
                            <div class="col-md-10 offset-md-1 col-lg-6 offset-lg-0">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" value="" readonly><?php echo $description ?></textarea>
                    </div>
